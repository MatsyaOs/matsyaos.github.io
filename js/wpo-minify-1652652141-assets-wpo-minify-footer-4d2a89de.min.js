...
if($skipUpdate)return!0;$html=SUPER.filter_if_statements($html);if($target.value||$target.dataset.value){if($target.value)$target.value=$html;if($target.dataset.value)$target.dataset.value=$html}else{$target.innerHTML=$html}
